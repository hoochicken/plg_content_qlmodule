...
class plgContentQlmodule extends JPlugin
{
    ...
    function getHtml($arr)
    {
        ...
        if (false!=$obj_module AND 1==self::checkPublished($obj_module))
        {
            if ('mod_qlmodule'!=$obj_module->module OR ('mod_qlmodule'==$obj_module->module AND 1==self::checkQlmoduleAllow($obj_module)))
            {
    ...
    */
     ...
     */
    function renderModule($obj_module,$params=array())
    {
    ...
    function checkPublished($module)
    {
        ...
        if
        (
            ('0000-00-00 00:00:00'==$module->publish_up AND '0000-00-00 00:00:00'==$module->publish_down)
            OR
            ('0000-00-00 00:00:00'==$module->publish_up AND $date<$module->publish_down)
            OR
            ($date>$module->publish_up AND '0000-00-00 00:00:00'==$module->publish_down)
            OR
            ($date>$module->publish_up AND $date<$module->publish_down)
        ) return true;
        else return false;
    }
    /**
